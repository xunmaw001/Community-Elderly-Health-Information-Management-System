...
//                            yishengYuyueEntity.setYishengYuyueUuidNumber(data.get(0));                    //报名编号 要改的
...
//                            yishengYuyueEntity.setYishengYuyueText(data.get(0));                    //报名理由 要改的
//                            yishengYuyueEntity.setYishengYuyueYesnoTypes(Integer.valueOf(data.get(0)));   //报名状态 要改的
//                            yishengYuyueEntity.setYishengYuyueYesnoText(data.get(0));                    //审核回复 要改的
