    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区老人健康信息管理系统注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='yisheng'">
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/sqlrjkxxglxt/img/back-img-bg.jpg);
