        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                     ...
                     <el-form-item :label="contents.inputTitle == 1 ? '健康信息名称' : ''">
                         <el-input prefix-icon="el-icon-search" v-model="searchForm.jiankangName" placeholder="健康信息名称" clearable></el-input>
                     </el-form-item>
         
                     <el-form-item :label="contents.inputTitle == 1 ? '健康类型' : ''">
                        <el-select v-model="searchForm.jiankangTypes" placeholder="请选择健康类型">
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/sqlrjkxxglxt/upload/jiankangMuBan.xls"
                        >批量导入健康信息数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jiankang','导入导出')"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                ...
                //本表字段
                     '健康信息名称': "jiankangName",
                     '健康类型': "jiankangValue",
                     '身体指标': "jiankangZhibiao",
                     '血压': "jiankangXueya",
                     '心率': "jiankangXinlv",
                     '健康信息编号': "jiankangUuidNumber",
                     '健康信息照片': "jiankangPhoto",
                     '录入时间': "insertTime",
            },
