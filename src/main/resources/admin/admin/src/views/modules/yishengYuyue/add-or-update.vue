    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报名编号" prop="yishengYuyueUuidNumber">
                       <el-input v-model="ruleForm.yishengYuyueUuidNumber"
                                 placeholder="报名编号" clearable  :readonly="ro.yishengYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报名编号" prop="yishengYuyueUuidNumber">
                           <el-input v-model="ruleForm.yishengYuyueUuidNumber"
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报名理由" prop="yishengYuyueText">
                        <el-input type="textarea"  :readonly="ro.yishengYuyueText" v-model="ruleForm.yishengYuyueText" placeholder="报名理由"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yishengYuyueText" label="报名理由" prop="yishengYuyueText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoTypes" label="报名状态" prop="yishengYuyueYesnoTypes">
                        <el-input v-model="ruleForm.yishengYuyueYesnoValue" placeholder="报名状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueYesnoText" label="审核回复" prop="yishengYuyueYesnoText">
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.yishengYuyueShenheTime" label="审核时间" prop="yishengYuyueShenheTime">
