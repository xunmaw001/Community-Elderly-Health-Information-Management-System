    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保信息名称" prop="yibaoName">
                       <el-input v-model="ruleForm.yibaoName"
                                 placeholder="医保信息名称" clearable  :readonly="ro.yibaoName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医保信息名称" prop="yibaoName">
                           <el-input v-model="ruleForm.yibaoName"
                                     placeholder="医保信息名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="医保类型" prop="yibaoTypes">
                        <el-select v-model="ruleForm.yibaoTypes" :disabled="ro.yibaoTypes" placeholder="请选择医保类型">
                            <el-option
                                v-for="(item,index) in yibaoTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="医保类型" prop="yibaoValue">
                        <el-input v-model="ruleForm.yibaoValue"
                            placeholder="医保类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="医保信息编号" prop="yibaoUuidNumber">
                       <el-input v-model="ruleForm.yibaoUuidNumber"
                                 placeholder="医保信息编号" clearable  :readonly="ro.yibaoUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="医保信息编号" prop="yibaoUuidNumber">
                           <el-input v-model="ruleForm.yibaoUuidNumber"
                                     placeholder="医保信息编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.yibaoPhoto" label="医保信息照片" prop="yibaoPhoto">
                        <file-upload
                            tip="点击上传医保信息照片"
                            action="file/upload"
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.yibaoPhoto?$base.url+ruleForm.yibaoPhoto:''"
                            @change="yibaoPhotoUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.yibaoPhoto" label="医保信息照片" prop="yibaoPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.yibaoPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医保信息介绍" prop="yibaoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.yibaoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.yibaoContent" label="医保信息介绍" prop="yibaoContent">
                            <span v-html="ruleForm.yibaoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ruleForm: {
                    ...
                    yibaoName: '',
                    yibaoTypes: '',
                    yibaoUuidNumber: new Date().getTime(),
                    yibaoPhoto: '',
                    yibaoContent: '',
                    yibaoDelete: '',
                    insertTime: '',
                ...
                rules: {
                   ...
                   yibaoName: [
                              { required: true, message: '医保信息名称不能为空', trigger: 'blur' },
                          ],
                   yibaoTypes: [
                              { required: true, message: '医保类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yibaoUuidNumber: [
                              { required: true, message: '医保信息编号不能为空', trigger: 'blur' },
                          ],
                   yibaoPhoto: [
                              { required: true, message: '医保信息照片不能为空', trigger: 'blur' },
                          ],
                   yibaoContent: [
                              { required: true, message: '医保信息介绍不能为空', trigger: 'blur' },
                          ],
                   yibaoDelete: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yibao_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yibaoTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.yibaoContent = _this.ruleForm.yibaoContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.yibaoContent = this.ruleForm.yibaoContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`yibao/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.yibaoCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            yibaoPhotoUploadChange(fileUrls){
                this.ruleForm.yibaoPhoto = fileUrls;
                this.addEditUploadStyleChange()
            },
