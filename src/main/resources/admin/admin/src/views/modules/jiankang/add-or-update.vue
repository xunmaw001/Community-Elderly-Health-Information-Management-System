    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yishengId" name="yishengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康信息名称" prop="jiankangName">
                       <el-input v-model="ruleForm.jiankangName"
                                 placeholder="健康信息名称" clearable  :readonly="ro.jiankangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康信息名称" prop="jiankangName">
                           <el-input v-model="ruleForm.jiankangName"
                                     placeholder="健康信息名称" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="健康类型" prop="jiankangTypes">
                        <el-select v-model="ruleForm.jiankangTypes" :disabled="ro.jiankangTypes" placeholder="请选择健康类型">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="健康类型" prop="jiankangValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="身体指标" prop="jiankangZhibiao">
                       <el-input v-model="ruleForm.jiankangZhibiao"
                                 placeholder="身体指标" clearable  :readonly="ro.jiankangZhibiao"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="身体指标" prop="jiankangZhibiao">
                           <el-input v-model="ruleForm.jiankangZhibiao"
                                     placeholder="身体指标" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="血压" prop="jiankangXueya">
                       <el-input v-model="ruleForm.jiankangXueya"
                                 placeholder="血压" clearable  :readonly="ro.jiankangXueya"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="血压" prop="jiankangXueya">
                           <el-input v-model="ruleForm.jiankangXueya"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="心率" prop="jiankangXinlv">
                       <el-input v-model="ruleForm.jiankangXinlv"
                                 placeholder="心率" clearable  :readonly="ro.jiankangXinlv"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="心率" prop="jiankangXinlv">
                           <el-input v-model="ruleForm.jiankangXinlv"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="健康信息编号" prop="jiankangUuidNumber">
                       <el-input v-model="ruleForm.jiankangUuidNumber"
                                 placeholder="健康信息编号" clearable  :readonly="ro.jiankangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="健康信息编号" prop="jiankangUuidNumber">
                           <el-input v-model="ruleForm.jiankangUuidNumber"
                                     placeholder="健康信息编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.jiankangPhoto" label="健康信息照片" prop="jiankangPhoto">
                        <file-upload
                            tip="点击上传健康信息照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.jiankangPhoto" label="健康信息照片" prop="jiankangPhoto">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="健康信息介绍" prop="jiankangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.jiankangContent" label="健康信息介绍" prop="jiankangContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiankangName: [
                              { required: true, message: '健康信息名称不能为空', trigger: 'blur' },
                          ],
                   jiankangTypes: [
                              { required: true, message: '健康类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   jiankangZhibiao: [
                              { required: true, message: '身体指标不能为空', trigger: 'blur' },
                          ],
                   jiankangXueya: [
                   ...
                   jiankangUuidNumber: [
                              { required: true, message: '健康信息编号不能为空', trigger: 'blur' },
                          ],
                   jiankangPhoto: [
                              { required: true, message: '健康信息照片不能为空', trigger: 'blur' },
                          ],
                   jiankangContent: [
                              { required: true, message: '健康信息介绍不能为空', trigger: 'blur' },
                          ],
                   jiankangDelete: [
